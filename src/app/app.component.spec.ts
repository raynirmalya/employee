...
import { JarvisToasterComponent, UiLoaderComponent } from './core/test-helpers/stub.component';
...
describe('AppComponent', () => {
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [AppComponent, JarvisToasterComponent, UiLoaderComponent],
